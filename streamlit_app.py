        ...
        if seleccion_reporte == "Reporte global":
                ...
                def generar_pdf():
                        ...
                        [ pdf.cell(width, 10, text, ln=True, align='C') for width, text in zip([200, 200, 200, 200, 200, 200], [
                            ...
                            'garantizar la continuidad del proceso educativo y el apoyo a los estudiantes, ya que su presencia es crucial para el desarrollo de las actividades académicas.'
                        ]) ]
