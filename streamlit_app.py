...
if seleccion_menu == "Jefe de grupo":
        ...
        if seleccion_reporte == "Reporte por profesor":
                ...
                def generar_pdf():
                        ...
                        pdf.cell(200, 10, 'El profesor:'seleccion_profeexd ' Ha impartido [ ] materias, durante [ periodo de tiempo] ', ln=True, align='C')
                        pdf.cell(200, 10, 'y de esas materias ha asistido [ ] y ha faltado [ ]', ln=True, align='C')
