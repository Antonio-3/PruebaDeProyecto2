        ...
        if seleccion_reporte == "Reporte global":
                ...
                def generar_pdf():
                        ...
                        [ pdf.cell(width, 10, text, ln=True, align='C') for width, text in zip([200, 200, 200, 200, 200, 200], [
                            ...
                            'Este porcentaje refleja un compromiso moderado de los docentes con su responsabilidad de asistir a clases y',
                            'cumplir con sus horarios. La asistencia regular de los maestros es fundamental para garantizar la continuidad del proceso educativo',
